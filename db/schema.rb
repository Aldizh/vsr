...
#   Mysql2::Error: SHOW VIEW command denied to user 'resell'@'50-202-33-26-static.hfc.comcastbusiness.net' for table 'calls_all': SHOW CREATE TABLE `calls_all`
...
#   Mysql2::Error: SHOW VIEW command denied to user 'resell'@'50-202-33-26-static.hfc.comcastbusiness.net' for table 'callshopcalls_list': SHOW CREATE TABLE `callshopcalls_list`

# Could not dump table "callshopcurrentcalls_list" because of following ActiveRecord::StatementInvalid
#   Mysql2::Error: SHOW VIEW command denied to user 'resell'@'50-202-33-26-static.hfc.comcastbusiness.net' for table 'callshopcurrentcalls_list': SHOW CREATE TABLE `callshopcurrentcalls_list`
...
#   Mysql2::Error: SHOW VIEW command denied to user 'resell'@'50-202-33-26-static.hfc.comcastbusiness.net' for table 'client_dids': SHOW CREATE TABLE `client_dids`
...
#   Mysql2::Error: SHOW VIEW command denied to user 'resell'@'50-202-33-26-static.hfc.comcastbusiness.net' for table 'clientspbx': SHOW CREATE TABLE `clientspbx`
...
#   Mysql2::Error: SHOW VIEW command denied to user 'resell'@'50-202-33-26-static.hfc.comcastbusiness.net' for table 'clientsretail': SHOW CREATE TABLE `clientsretail`
...
#   Mysql2::Error: SHOW VIEW command denied to user 'resell'@'50-202-33-26-static.hfc.comcastbusiness.net' for table 'dialingplan_lcr': SHOW CREATE TABLE `dialingplan_lcr`
...
#   Mysql2::Error: SHOW VIEW command denied to user 'resell'@'50-202-33-26-static.hfc.comcastbusiness.net' for table 'em_aps_time_table': SHOW CREATE TABLE `em_aps_time_table`
...
#   Mysql2::Error: SHOW VIEW command denied to user 'resell'@'50-202-33-26-static.hfc.comcastbusiness.net' for table 'gkregistrarroute': SHOW CREATE TABLE `gkregistrarroute`
...
#   Mysql2::Error: SHOW VIEW command denied to user 'resell'@'50-202-33-26-static.hfc.comcastbusiness.net' for table 'pbx_subaccounts': SHOW CREATE TABLE `pbx_subaccounts`
...
#   Mysql2::Error: SHOW VIEW command denied to user 'resell'@'50-202-33-26-static.hfc.comcastbusiness.net' for table 'portal_fax_task': SHOW CREATE TABLE `portal_fax_task`
...
#   Mysql2::Error: SHOW VIEW command denied to user 'resell'@'50-202-33-26-static.hfc.comcastbusiness.net' for table 'resellers': SHOW CREATE TABLE `resellers`
...
#   Mysql2::Error: SHOW VIEW command denied to user 'resell'@'50-202-33-26-static.hfc.comcastbusiness.net' for table 'retailroute': SHOW CREATE TABLE `retailroute`
...
#   Mysql2::Error: SHOW VIEW command denied to user 'resell'@'50-202-33-26-static.hfc.comcastbusiness.net' for table 'tariff_to_dnis': SHOW CREATE TABLE `tariff_to_dnis`
